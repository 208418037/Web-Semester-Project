...
(function($, win, doc) {
  ...
  Rondell = (function() {
    ...
    Rondell.prototype._start = function() {
      ...
      if (controls.enabled) {
        this.controls._shiftLeft = $("<a title=\"上一頁\" href=\"#/\"/>").addClass("" + classControl + " " + classShiftLeft).html(this.strings.prev).click(this.shiftLeft).css({
          left: controls.margin.x,
          top: controls.margin.y,
          zIndex: this.zIndex + this.maxItems + 2
        });
        this.controls._shiftRight = $("<a title=\"下一頁\" href=\"#/\"/>").addClass("" + classControl + " " + classShiftRight).html(this.strings.next).click(this.shiftRight).css({
    ...
    Rondell.prototype.showLightbox = function() {
      ...
      return lightboxContent.stop().fadeTo(100, 0, function() {
        ...
        if (icon && icon.length>0 && !icon[0].complete) {
